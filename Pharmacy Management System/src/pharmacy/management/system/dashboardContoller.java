...
public class dashboardContoller implements Initializable {
    ...
    @FXML
    private Button addMedicines_cleanBtn;

    @FXML
    private TableColumn<medicineData, String> addMedicines_coi_brand;

    @FXML
    private TableColumn<medicineData, String> addMedicines_coi_date;

    @FXML
    private TableColumn<medicineData, String> addMedicines_coi_price;

    @FXML
    private TableColumn<medicineData, String> addMedicines_coi_productName;

    @FXML
    private TableColumn<medicineData, String> addMedicines_coi_status;

    @FXML
    private TableColumn<medicineData, String> addMedicines_coi_type;
    ...
    private Label dashboad_availableMed;
    ...
    @FXML
    private TableColumn<customerData, String> purchase_coi_brand;

    @FXML
    private TableColumn<customerData, String> purchase_coi_price;

    @FXML
    private TableColumn<customerData, String> purchase_coi_productName;

    @FXML
    private TableColumn<customerData, String> purchase_coi_qty;

    @FXML
    private TableColumn<customerData, String> purchase_coi_type;
    ...
    @FXML
    private TableColumn<medicineData, String> addMedicines_coi_medicineID;
    ...
    @FXML
    private TableColumn<customerData, String> purchase_coi_medicineId;
    ...
    @FXML
    private AreaChart<?, ?> dashborad_chart;

    public void homeChart() {
        dashborad_chart.getData().clear();
        ...
        try {
            ...
            dashborad_chart.getData().add(chart);
    ...
    public void homeTI() {
        ...
        try {
            ...
            dashboard_totalIncome.setText(String.valueOf(totalDisplay) + "TK ");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
        ...
        try {
            ...
            if (addMedicines_medicineID.getText().isEmpty()
                ...
                if(option.get().equals(ButtonType.OK)) {
                    ...
                    alert.setTitle("Information Message");
                    alert.setHeaderText(null);
                    alert.setContentText("Successfullt Update");
                    alert.showAndWait();
    ...
    @FXML
    public void addaMedicineDelete() {
        ...
        try {
            ...
            if (addMedicines_medicineID.getText().isEmpty()
                ...
                if (option.get().equals(ButtonType.OK)) {
                    ...
                    alert.setTitle("Information Message");
                    alert.setHeaderText(null);
                    alert.setContentText("Successfullt Deleted!");
                    alert.showAndWait();
    ...
    private String[] addMedicineListT = {"Hydrocodone", "Antibiotics", "Metormn", "Lsartan", "Albuterol"};
    ...
    @FXML
    public void addMedicineImportImage() throws MalformedURLException {
        ...
        if (file != null) {
            ...
            image = new Image(file.toURL().toString(), 127, 143, false, true);
    ...
    public void addMedicineShowListData() {
        ...
        addMedicines_coi_medicineID.setCellValueFactory(new PropertyValueFactory<>("medicineId"));
        addMedicines_coi_brand.setCellValueFactory(new PropertyValueFactory<>("brand"));
        addMedicines_coi_productName.setCellValueFactory(new PropertyValueFactory<>("productName"));
        addMedicines_coi_type.setCellValueFactory(new PropertyValueFactory<>("type"));
        addMedicines_coi_price.setCellValueFactory(new PropertyValueFactory<>("price"));
        addMedicines_coi_status.setCellValueFactory(new PropertyValueFactory<>("status"));
        addMedicines_coi_date.setCellValueFactory(new PropertyValueFactory<>("date"));
    ...
    public void addMedicineSearch() {
        ...
        addMedicines_search.setOnKeyTyped(event -> {
            filter.setPredicate(predicateMedicineData -> {
                String newValue = addMedicines_search.getText();
                ...
                if (predicateMedicineData.getMedicineId() != null && predicateMedicineData.getMedicineId().toString().contains(searchKey)) {
                    return true;
                } else if (predicateMedicineData.getBrand() != null && predicateMedicineData.getBrand().toLowerCase().contains(searchKey)) {
                    return true;
                } else if (predicateMedicineData.getProductName() != null && predicateMedicineData.getProductName().toLowerCase().contains(searchKey)) {
                    return true;
                } else if (predicateMedicineData.getType() != null && predicateMedicineData.getType().toLowerCase().contains(searchKey)) {
                    return true;
                } else if (predicateMedicineData.getStatus() != null && predicateMedicineData.getStatus().toLowerCase().contains(searchKey)) {
                    return true;
                } else if (predicateMedicineData.getPrice() != null && predicateMedicineData.getPrice().toString().contains(searchKey)) {
                    return true;
                } else if (predicateMedicineData.getDate() != null && predicateMedicineData.getDate().toString().contains(searchKey)) {
                    return true;
                } else {
                    return false;
                }
    ...
    public void addMedicineSelect() {
        ...
        image = new Image(uri, 127, 143, false, true);
        addMedicines_imageView.setImage(image);
    ...
    public void purchaseDisplayTotal() {
        ...
        try {
            ...
            purchase_total.setText(String.valueOf(totalPriceD + "TK "));
    ...
    public void purchaseAmount() {
        ...
        if (purchase_amount.getText().isEmpty() || totalPriceD == 0) {
            ...
            if (totalPriceD > amount) {
                ...
                purchase_balance.setText(String.valueOf(balance) + "TK ");
            }
        }
    }
        ...
        try {
            ...
            if (totalPriceD == 0) {
                ...
                if (option.get().equals(ButtonType.OK)) {
                    ...
                    purchase_amount.setText("");
                    purchase_balance.setText("0.0 TK");
                }
            }
    ...
    public void purchaseShowListData() {
        ...
        purchase_coi_medicineId.setCellValueFactory(new PropertyValueFactory<>("medicineId"));
        purchase_coi_brand.setCellValueFactory(new PropertyValueFactory<>("brand"));
        purchase_coi_productName.setCellValueFactory(new PropertyValueFactory<>("productName"));
        purchase_coi_type.setCellValueFactory(new PropertyValueFactory<>("type"));
        purchase_coi_qty.setCellValueFactory(new PropertyValueFactory<>("quantity"));
    ...
    public void switchForm(ActionEvent event) {
        ...
        if (event.getSource() == dashboard_btn) {
            ...
            dashboard_btn.setStyle("-fx-background-color:  linear-gradient(to bottom right,#41b170, #8a418c);");
            addMed_btn.setStyle("-fx-backgound-color:transparent");
            pruchase_btn.setStyle("-fx-backgound-color:transparent");
            ...
            dashboard_btn.setStyle("-fx-backgound-color:transparent");
            pruchase_btn.setStyle("-fx-backgound-color:transparent");
